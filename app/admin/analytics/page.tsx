...
export default function AnalyticsPage() {
   ...
   * AUTHENTICATION
   *
   * We first get the authenticated user.
   * Then we check the existing is_admin() RPC.
   *
   * IMPORTANT:
   * We do NOT sign the user out when the RPC fails.
   * A temporary RPC/network error should never destroy
   * an otherwise valid admin session.
   */
  async function checkAdmin() {
    ...
    try {
      ...
      /*
       * Supabase normally returns boolean true here.
       * String "true" is also accepted defensively.
       */
      const isAdmin =
        adminResult === true ||
        adminResult === "true";
  ...
  /*
   * GROUP EVENTS INTO VISITOR SESSIONS
   */
